...
namespace Handy2DTools.CharacterController.Checkers
{
    ...
    public class SlopeChecker : Checker, ISlopeDataProvider
    {
        #region Inspector
        ...
        [ShowIf("debugOn"), SerializeField, ReadOnly]
        protected SlopeData currentSlopeData;
        ...
        [Foldout("Seekers")]
        [Tooltip("If you guarantee your GameObject has a component wich implements an IHorizontalFacingDirectionProvider you can mark this and it will subscribe to its events. PCActions implements it.")]
...
>>>>>>> 4d3f3e0de14d3b96eb66728515a34f4b1632f1cf
        ...
        public SlopeData Data => currentSlopeData;
...
>>>>>>> 4d3f3e0de14d3b96eb66728515a34f4b1632f1cf
        ...
        protected override string DocPath => "en/core/character-controller/checkers/slope-checker.html";
        protected override string DocPathPtBr => "pt_BR/core/character-controller/checkers/slope-checker.html";
