...
{
    [AddComponentMenu("Handy 2D Tools/Character Controller/Platformer/Checkers/PlatformerRayCastGroundingChecker")]
    ...
    public class PlatformerRayCastGroundingChecker : Checker, IPlaftormerGroundingProvider, IPlatformerGroundingChecker
    {
        ...
        protected virtual void FindComponents()
        {
            ...
            SeekComponent<IPlatformerVerticalDirectionProvider>(seekVerticalDirectionProvider, ref verticalDirectionProvider);
        }
        ...
        protected override string DocPath => "core/character-controller/platformer/checkers/platformer-raycast-grounding-checker.html";
