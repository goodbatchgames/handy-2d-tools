...
namespace Handy2DTools.CharacterController.Platformer
{
    ...
    [AddComponentMenu("Handy 2D Tools/Character Controller/Platformer/Abilities/Movement/PlatformerDynamicMovement")]
    public class PlatformerDynamicMovement : DocumentedComponent, IPlatformerMovementPerformer
    {
        #region Editor
        ...
        public float CurrentGravityScale => rb.gravityScale;
        ...
        protected override string DocPath => "core/character-controller/platformer/abilities/movement/platformer-dynamic-movement.html";
